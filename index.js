...
function copyObject(obj) {
  let newObj = { ...animal } // Використовуємо синтаксис деструктурізації {...person} для створення нового об'єкта з тими ж властивостями
  return newObj // Повертаємо новий об'єкт
}
...
function changeRole(array, newRole) {
  for (const item of array) {
    ...
    item.role = newRole // Змінюємо роль кожного користувача на нове ім'я
    console.log(item) // Виводимо об'єкт на консоль
  }
}
